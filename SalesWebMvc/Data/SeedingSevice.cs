...
{
    //SERVIÇO DE POPULAR A BASE DE DADOS

    public class SeedingSevice
    {
        //registrar uma injeção dependencia com o dbcontext
        //quando um seeding service for criado ele vai receber uma instancia do context tbm
        private SalesWebMvcContext _context;
        public SeedingSevice(SalesWebMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            //verificar se existe registro na tabela mysql
            if (_context.Department.Any() || 
                _context.Seller.Any() || 
                _context.SalesRecord.Any())
            {
                return; //não faz nada se existir registros, banco ja populado
            }
            ...
            //Será efetivado quando colocado no startup,, dentro do configure.
        }
